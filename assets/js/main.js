...
const sendMail = (formData) => {
    const data = {
        service_id: 'service_xm37sby',
        template_id: 'template_04qbhdg',
        user_id: "user_bKUOBmI03qhZy62VZffUM",
...
submitBtn.addEventListener('click', function(e) {
    ...
    const fields = {
        'name': formData.get('name') || 'missing-field',
        'email': formData.get('email'),
        'subject': formData.get('subject') || 'missing-field',
